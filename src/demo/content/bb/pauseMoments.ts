// Big Brother Australia pause-moments adapter.
//
// Owns only the BB-specific JSON documents and the resolver exports.
...
//   - cta-pause.json     ←  scripts/generate-cta-pause-moments.mjs --content bb --windows 94-154,165-225
//   - organic-pause.json ←  scripts/generate-organic-pause-moments.mjs --content bb
//
...
import { BB_CONTENT_ID } from './timeline'
...
export function getActivePauseOverlayPayload(
  ...
  return buildPauseOverlayPayload(match.scene, match.campaign, BB_CONTENT_ID)
}
