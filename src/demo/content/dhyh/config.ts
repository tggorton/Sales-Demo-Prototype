 ...
 * reads `adModesByTier` first and falls back to `defaultAdModes` when
 * the active tier has no override; either way the result is
 * intersected with the globally-enabled set in the registry.
 */
