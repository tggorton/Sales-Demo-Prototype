// Summer House content-specific constants. Parallel to
...
export const SH_CONTENT_ID = 'sh'

/** Bundled clip. Override via `VITE_SH_VIDEO_URL` if hosting elsewhere. */
export const SH_VIDEO_URL = envString(
  'VITE_SH_VIDEO_URL',
  '/assets/video/sh.mov'
)
...
export const SH_CLIP_DURATION_SECONDS = 191.68
...
export const SH_TIER_TIME_BASE: 'clip' | 'source' = 'clip'
...
export const SH_AD_BREAK_CLIP_SECONDS = 191.68

// Legacy aliases the scene builder consumes — kept for parity with DHYH's
// surface even when the time base is 'clip'.
export const SH_CLIP_START_SECONDS = 0
export const SH_CLIP_END_SECONDS = SH_CLIP_DURATION_SECONDS
...
// `scripts/generate-cta-pause-moments.mjs --content sh --windows ...`
...
// the carousel.
export const SH_ORGANIC_PAUSE_CTA_END_SECONDS = 15

export type ShPauseWindow = { readonly start: number; readonly end: number }
...
export const SH_CTA_PAUSE_WINDOWS: ReadonlyArray<ShPauseWindow> =
