...
| **7b. Playwright golden-path + hook/component tests** | Playwright install + config; golden-path script (login → DHYH → Tier 3 + Sync: Impulse → ad-break visibility). jsdom-based hook tests for HANDOFF §9 panel-scroll discontinuity heuristic. | Low–Medium | ⏳ Pending |
